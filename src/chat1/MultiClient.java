...
/*
* cmd -> cd \
* 		-> cd 02WorkSpaces\ko1networkchat\bin\java chat1.MultiClient
* 
* IP 주소를 매개변수로 전달하기
* java chat1.MultiClient 192.168.219.146
*/
...
public class MultiClient {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(args.length>0) {	// 전달되는 매개값이 있으면.
				ServerIP = args[0];
			}
